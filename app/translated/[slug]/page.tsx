    ...
    useEffect(() => {
        const handleKeyDown = (e: KeyboardEvent) => {
            if (e.key === "ArrowLeft" && currentParagraph > 0) {
                ...
                e.key === "ArrowRight" &&
                currentParagraph < translatedEssay.paragraphs.length - 1
            ) {
                setCurrentParagraph((prev) => prev + 1);
            }
        };
            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="mb-8 p-4 bg-gray-900 rounded-lg border border-gray-800">
                    <div className="flex items-center justify-between mb-4">
                        <span className="text-gray-400">
                            진행률: {currentParagraph + 1} /{" "}
                            {translatedEssay.paragraphs.length}
                        </span>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                    {settings.showEnglish && (
                        <div
                            className={`p-6 bg-gray-900 rounded-lg border border-gray-800 ${
                                !settings.showKorean ? "md:col-span-2" : ""
                            }`}
                        >
                            ...
                            <p
                                className={`text-gray-200 leading-relaxed ${getFontSizeClass()}`}
                            >
                                {
                                    translatedEssay.paragraphs[currentParagraph]
                                        .english
                                }
                            </p>
                        </div>
                    ...
                    {settings.showKorean && (
                        <div
                            className={`p-6 bg-gray-900 rounded-lg border border-gray-800 ${
                                !settings.showEnglish ? "md:col-span-2" : ""
                            }`}
                        >
                    ...
                    <button
                        onClick={() =>
                            setCurrentParagraph((prev) =>
                                Math.min(
                                    translatedEssay.paragraphs.length - 1,
                                    prev + 1
                                )
                            )
                        }
